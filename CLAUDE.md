...
**YOU ARE IN: `bepobot/polecats/chrome/`** — This is YOUR worktree. Stay here.

- **ALL file operations** must be within this directory
- **Use absolute paths** when writing files
- **NEVER** write to `~/gt/bepobot/` (rig root) or other directories
...
**Your mail address:** `bepobot/polecats/chrome`
**Your rig:** bepobot
**Your Witness:** `bepobot/witness`
...
| Ask Witness for help | `gt mail send bepobot/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`bepobot/witness`) when:
...
```bash
gt mail send bepobot/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
